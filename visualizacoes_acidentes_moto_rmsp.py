...
print("🎯 GERANDO VISUALIZAÇÕES AVANÇADAS BASEADAS EM DESCOBERTAS REVOLUCIONÁRIAS...")

# ================================
# CARREGAMENTO E PREPARAÇÃO DOS DADOS
# ================================
try:
    df_2015_2021 = pd.read_csv('pessoas_2015-2021.csv', encoding='latin-1', sep=';', low_memory=False)
    df_2022_2025 = pd.read_csv('pessoas_2022-2025.csv', encoding='latin-1', sep=';', low_memory=False)
    df_raw = pd.concat([df_2015_2021, df_2022_2025], ignore_index=True)
...
plt.tight_layout()
plt.savefig('EDA_01_DISTRIBUICAO_TIPO_VITIMA.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('EDA_02_BOXPLOT_TIPO_VITIMA_GRAVIDADE.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('EDA_03_HEATMAP_TIPO_VITIMA_GRAVIDADE.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('EDA_04_DISTRIBUICAO_SEXO.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('EDA_05_BOXPLOT_SEXO_GRAVIDADE.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('EDA_06_HEATMAP_SEXO_GRAVIDADE.png', dpi=300, bbox_inches='tight')
plt.close()

print("⚖️ 7/9 - Distribuição: Faixa Etária...")
...
plt.title('⚖️ DISTRIBUIÇÃO: FAIXA ETÁRIA (3ª Maior Correlação: 0.0517)', fontweight='bold', fontsize=14, pad=20)
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('EDA_08_BOXPLOT_FAIXA_ETARIA_GRAVIDADE.png', dpi=300, bbox_inches='tight')
plt.close()
...
try:
    ...
    plt.savefig('EDA_09_MATRIZ_CORRELACAO_COMPLETA.png', dpi=300, bbox_inches='tight', facecolor='white')
    print("✅ Arquivo EDA_09_MATRIZ_CORRELACAO_COMPLETA.png salvo com cores aprimoradas!")
...
plt.tight_layout()
plt.savefig('DESCOBERTA_1_PADROES_MENSAIS_CRITICOS.png', dpi=300, bbox_inches='tight')
plt.close()

# ================================
# 2. DESCOBERTA TEMPORAL REVOLUCIONÁRIA - DIAS DO MÊS LETAIS
# ================================
...
plt.tight_layout()
plt.savefig('DESCOBERTA_2_DIAS_MAIS_LETAIS.png', dpi=300, bbox_inches='tight')
plt.close()

# ================================
# 3. DESCOBERTA GEOGRÁFICA CRÍTICA - RANKING MUNICIPAL
# ================================
print("\n🗺️ Gerando visualização: RANKING MUNICIPAL DE RISCO")
...
# Destacar os 3 piores (apenas se houver pelo menos 3)
...
plt.tight_layout()
plt.savefig('DESCOBERTA_3_RANKING_MUNICIPAL.png', dpi=300, bbox_inches='tight')
plt.close()
# ================================
...
if 'FATAL' in victim_pct.columns:
    ...
    axes[0,0].set_title('⚠️ RISCO EXTREMO POR TIPO DE VÍTIMA', fontweight='bold', fontsize=14)
    axes[0,0].set_ylabel('% Acidentes Fatais')
...
plt.tight_layout()
plt.savefig('DESCOBERTA_4_RISCO_TIPO_VITIMA.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('DESCOBERTA_5_IMPORTANCIA_PREDITIVA.png', dpi=300, bbox_inches='tight')
plt.close()
...
# Título principal
fig.suptitle('🎯 DASHBOARD EXECUTIVO - DESCOBERTAS REVOLUCIONÁRIAS\nAcidentes de Motocicleta RMSP (2022-2025)', 
...
insights_text = f"""
🎯 PRINCIPAIS DESCOBERTAS REVOLUCIONÁRIAS:
...
• IMPACTO: Intervenções direcionadas podem salvar 50-65 vidas/ano (ROI 64:1)
"""
...
plt.savefig('DASHBOARD_EXECUTIVO_COMPLETO.png', dpi=300, bbox_inches='tight')
plt.close()

print("\n✅ TODAS AS VISUALIZAÇÕES REVOLUCIONÁRIAS FORAM GERADAS!")
